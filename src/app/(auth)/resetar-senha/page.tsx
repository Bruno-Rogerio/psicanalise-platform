  ...
  return (
    <div>
      ...
      <div className="text-center">
        <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-sage-400/20 to-sage-500/20">
          <LockIcon className="h-7 w-7 text-sage-600" />
        </div>
